## plot1.R code for the plotting of data from the "household_power_consumption.txt" dataset
## This plot is to produce a Histogram of Frequency vs Global Active Power (kilowatts)
...
## Using the Hist funtion create the histogram
## Referance Manual https://stat.ethz.ch/R-manual/R-devel/library/graphics/html/hist.htm
...
## Save the output of the plot/histogram to a file called "plot1.png"
